            ...
            <div className="text">
              <ul className="point">
                <li>
                  ...
                  <ul className="subPoint">
                    <li>
                      AI algorithms to help each kid in achieving their learning
                      goals
                    </li>
                  </ul>
                </li>
              ...
              <ul className="point">
                <li>
                  ...
                  <ul className="subPoint">
                    <li>
                      Learn the same concepts in different animations as per
                      users choice.
                    </li>
                  </ul>
                </li>
            ...
            <div className="description">
              <div className="point">
                <div className="text">
                  ...
                  <p>
                    Get The Best Lessons anytime. Zero Downtime and its a
                    promise.
                  </p>
                </div>
                <div className="image">
              ...
              <div className="point">
                <div className="text">
                  ...
                  <p>Code on the platform. Zero Setup</p>
                </div>
                <div className="image">
                  <div className="img" />
                </div>
